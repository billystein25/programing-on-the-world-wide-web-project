...
# Usage
The website should open via index.php in which you can create new users by filling the respective forms, or log in using the user's credentials. If you log in as a secretary you will have the option to import a .json file filled with users. Such a .json file is provided [here](.github/include/db-export.php.json).
